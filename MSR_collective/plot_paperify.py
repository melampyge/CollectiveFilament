...
def main(): 
    ...
    density = [0.08]
    kappa = [2.5, 5.0, 62.5, 125.0, 200.0]
    fp = [0.08, 7.0]
#    density = [0.08, 0.2]
    ...
    for d in density:
        ...
        for f in fp:
            ...
            for k in kappa:
                ...
                path = generate_path(str(d),str(k),str(f),"MSD")
...
#                print popt[1]
        ...
        for i, f in enumerate(fp):
            ...
            ax[i].set_xlabel('$\Delta t/\\tau$', weight='bold', size=40)
        ...
        ax[0].set_ylabel('$\Delta r^2/L^2$', weight='bold', size=40)
        
        #plt.setp(ax[0].get_yticklabels(),visible=False)
        plt.setp(ax[1].get_yticklabels(),visible=False)

        ax[1].legend(bbox_to_anchor=(0.02,0.,0.45,1.), loc=2, borderaxespad=0., prop={'size': 20}, mode="expand", frameon=False)
