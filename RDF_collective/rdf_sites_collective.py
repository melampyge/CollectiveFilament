...
def compute_rdf_single(x, y, nbin, rmax, lx, ly, natoms, mol):
    ...
    rdf_site.compute(nsegx, nsegy, natoms, head, llist, mol, x, y, rdf, lx, ly, rmax, nbin)
    """
...
def compute_rdf(charfile, headerfile, nfil, nskip, nbin, rmax, ntotal):
    ...
    nsteps = nsteps - nskip
    ### update nsteps based on the total number fo snapshots to be used
    ...
    for step in range(nsteps):
        ...
        rdfi = compute_rdf_single(x, y, nbin, rmax, lx, ly, natoms, mol)
        ### copy rdfi to rdf
        for i in range(nbin):
            rdf[i,step] = rdfi[i]
...
def main():
    ...
    nsteps, time, r, rdf = compute_rdf(charfile, headerfile, nfil, nskip, nbin, rmax, ntotal)
