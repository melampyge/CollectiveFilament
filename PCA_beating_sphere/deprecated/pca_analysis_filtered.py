...
def main():
    ...
    ### apply gauss-filter to curvature coordinates
    curv_filtered = ndimage.filters.gaussian_filter1d(curv, 1, axis = 0)
    
    ### perform principal component analysis
    print 'performing pca'
    eval, evec, correlation_matrix = pma.pma(curv_filtered)
    ...
    namp = len(amplitudes)
    nsteps = len(time)
    ofile = open(ofname + '/amplitudes_full.data', 'w')
