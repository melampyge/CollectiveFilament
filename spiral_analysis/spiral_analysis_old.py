...
def plot_data(sfolder, nsteps, lx, ly, time, xedges, yedges, rho_hist, vx_hist, vy_hist, vorticity):
    ...
    for i in range(nsteps):
        ...
        ax.set_xlabel('x/r', fontsize=30)
        ax.set_ylabel('y/r', fontsize=30)
...
#    ofile.close()
    ...
    plot_data(sfolder, nsteps, lx, ly, time, xedges, yedges, rho_hist, vx_hist, vy_hist, vorticity)
