...
def main(): 
    ...
    parser.add_argument("analysis", help="Type of analysis in folder format")
    parser.add_argument("savefile", help="Folder in which figures should be saved")
    args = parser.parse_args()
    analysis_type = args.analysis[13:]
...
#        i0prev = i
        ...
        ax[subcnt].set_title( analysis_type + ' , ' + labels[compareby] + " = " + "{0:.2f}".format(i), \
    ...
    path2 = args.savefile + '/plots/phase/CLUSTER'
    if os.path.exists(path1) == False:
        os.mkdir(path1)
    if os.path.exists(path2) == False:  
        os.mkdir(path2)
        
    plt.savefig(path2 +  '/' + analysis_type + '_set_' + \
