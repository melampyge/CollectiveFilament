...
datafile = args.initfile+"/OzerCluster"
...
#    cax1.set_rlim([-1,1])
    ...
    ax2 = subp.addSubplot()
    #weights = np.ones_like(clsizes.cs)/len(clsizes.cs)
    ...
    #ax2.xaxis.set_ticks( np.arange(1.0e+0,1.0e+5) )
    #ax2.yaxis.set_ticks( np.arange(1.0e-3,1.0e+0) )
