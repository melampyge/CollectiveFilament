...
#                        yfit = explaw(x, popt[0], popt[1]) 
        ...
        for i, f in enumerate(fp):
            ...
            ax[i].set_xlabel('m', weight='bold', size=30)
        ...
        ax[0].set_ylabel('<P(m)>', weight='bold', size=30)
        
        plt.setp(ax[1].get_yticklabels(),visible=False)
        plt.setp(ax[2].get_yticklabels(),visible=False)

        ax[2].legend(bbox_to_anchor=(0.6,0.,0.45,1.), loc=2, borderaxespad=0., prop={'size': 20}, mode="expand", frameon=False)
