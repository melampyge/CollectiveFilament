...
def main(): 
    ...
    density = [0.08]
    kappa = [1.25]
    fp = [0.0, 0.024, 0.08, 0.24, 0.8, 7.0]
#    density = [0.08, 0.2]
...
#            ax[i].set_xlim((0,4))
#            ax[i].set_ylim((10**-5, 10)) 
#            ax[i].xaxis.set_ticks( [0., 1., 2., 3., 4.] )
#            ax[i].yaxis.set_ticks( [10**-6, 10**-4, 10**-2, 10**0])
        ...
        ax[0].legend(bbox_to_anchor=(0.61,0.,0.27,1.), loc=2, borderaxespad=0., prop={'size': 22}, mode="expand", frameon=False)
