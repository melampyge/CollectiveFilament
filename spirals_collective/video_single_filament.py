...
## 
## Generate a video with color coding a single filament
##
...
def plot_frames(ti, tf, database, savebase, save):
    ...
    for frame in np.arange(ti, tf, nsamp):
        ...
        savepath1 = savebase + "single_frame-" + "{0:05d}".format(int(frame)) + ".png"
        savepath2 = savebase + "single_frame-" + "{0:05d}".format(int(frame)) + ".eps"
        ...
        line0 = ax0.scatter(p.xi/B, p.yi/B, s=1, c=p.color, \
